...
class news_adapter(private val listener: MainActivity): RecyclerView.Adapter<News_view_holder>() {
...
class News_view_holder(itemView: View) : RecyclerView.ViewHolder(itemView) {
